...
- (void)drawRect:(CGRect)rect {
    ...
    NSString *tipStr = VLocalize(@"scan_qr_code_tip_text");
...
- (UIView *)slider {
    if (!_slider) {
        ...
        _slider = [[UIView alloc] initWithFrame:frame];
        [_slider setContentMode:UIViewContentModeScaleToFill];
        _slider.layer.contents = (id)[UIImage imageNamed:@"scan_slider"].CGImage;
