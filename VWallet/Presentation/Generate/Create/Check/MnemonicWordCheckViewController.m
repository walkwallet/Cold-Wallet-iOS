...
- (IBAction)sibmitBtnClick {    
    ResultParameter *parameter = [ResultParameter paramterWithImgResourceName:@"ico_backup_success_tip" title:VLocalize(@"mnemonic_word_backup_success_tip_title") message:VLocalize(@"mnemonic_word_backup_success_tip_message")];
    [parameter setOperateBtnTitle:VLocalize(@"confirm")];
